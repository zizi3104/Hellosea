...
html = html.replace('<html lang="en">', '<html lang="en" data-preview="true">').replace('<body data-page="home">','<body data-page="all">');
...
html = html.replaceAll('href="/"', 'href="#main"').replaceAll('href="/our-story"','href="#story"').replaceAll('href="/ayo-surf"','href="#ayosurf"').replaceAll('href="/photos"','href="#gallery"').replaceAll('href="/q-and-a"','href="#faq"').replaceAll('href="/booking-inquiry"','href="#inquire"').replace('</body>', `<script>${i18n}</script><script>${js}</script><script>${gallery}</script><script>${team}</script><script>${pricing}</script></body>`);
